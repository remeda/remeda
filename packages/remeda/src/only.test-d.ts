...
test("simple array", () => {
  const result = only([] as number[]);

  expectTypeOf(result).toEqualTypeOf<number | undefined>();
});

test("simple non-empty array", () => {
  const result = only([1] as [number, ...number[]]);
...
test("array with more than one item", () => {
  const result = only([1, 2] as [number, number, ...number[]]);
...
test("tuple with two last", () => {
  const result = only(["a", 1, 2] as [...string[], number, number]);

  expectTypeOf(result).toEqualTypeOf<undefined>();
});

test("tuple with first and last", () => {
  const result = only([1, "a", 2] as [number, ...string[], number]);
...
test("simple readonly array", () => {
  const result = only([] as readonly number[]);

  expectTypeOf(result).toEqualTypeOf<number | undefined>();
});

test("simple non-empty readonly array", () => {
  const result = only([1] as readonly [number, ...number[]]);
...
test("readonly array with more than one item", () => {
  const result = only([1, 2] as readonly [number, number, ...number[]]);
