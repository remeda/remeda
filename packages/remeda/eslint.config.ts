          ...
          allow: [
            {
              ...
              package: "type-fest",
              name: [
                // A brand carries no runtime data, so mutability is meaningless
                // for it; type-fest builds one out of a mapped object type
                // which this rule reads as mutable.
                "Tag",
              ],
            },
            {
