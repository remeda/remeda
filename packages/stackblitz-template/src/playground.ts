// Welcome to the Remeda TypeScript Playground. Use this file to test out how
// Remeda utilities enforce input parameters and how it shapes the output.

// This file is typechecked with the same TypeScript configuration that the
// TypeScript Playground at https://typescriptlang.org/play uses; this is not
