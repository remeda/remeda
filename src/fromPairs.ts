 ...
 * @category Object
 */
export function fromPairs<V>(tuples: readonly [number, V][]): Record<number, V>;
export function fromPairs<V>(tuples: readonly [string, V][]): Record<string, V>;

export function fromPairs(tuples: readonly [string | number, unknown][]) {
