...
const dataProvider = (t: 'string' | 'boolean' | 'object' | 'function' | 'array' | 'date' | 'undefined' | 'null' | 'error' | 'number' | 'promise'): TestObj => {
  switch (t) {
    case 'number':
      return 5
    case 'array':
...
describe('Describe guards behavior', () => {
  ...
  test('isString: should work as type guard in array', () => {
    const data = [dataProvider('error'), dataProvider('string'), dataProvider('function'), dataProvider('null'), dataProvider('array'), dataProvider('boolean')].filter(isString)
  ...
  test('isBoolean: should work as type guard in filter', () => {
    const data = [dataProvider('error'), dataProvider('array'), dataProvider('function'), dataProvider('null'), dataProvider('array'), dataProvider('boolean')].filter(isBoolean)
  ...
  test('isArray: should work as type guard in filter', () => {
    const data = [dataProvider('error'), dataProvider('array'), dataProvider('function'), dataProvider('null'), dataProvider('array'), dataProvider('date')].filter(isArray)
  ...
  test('isDate: should work as type guard in filter', () => {
    const data = [dataProvider('error'), dataProvider('array'), dataProvider('function'), dataProvider('null'), dataProvider('number'), dataProvider('date')].filter(isDate)
  ...
  test('isDefined": should work as type guard', () => {
    ...
    if (isDefined(data)) {
      expect(data instanceof Date).toEqual(true);
      assertType<boolean | string | { a: string } | (() => void) | number[] | Date | Error | number | Promise<number>>(data)
    }
  });
  test('isDefined: should work as type guard in filter', () => {
    const data = [dataProvider('error'), dataProvider('array'), dataProvider('function'), dataProvider('null'), dataProvider('number')].filter(isDefined)
    expect(data.length === 4).toEqual(true)
    assertType<(string | number | boolean | {
      a: string;
    } | (() => void) | number[] | Date | Error | Promise<number>)[]>(data)
  });
  ...
  test('isNil: should work as type guard in filter', () => {
    const data = [dataProvider('error'), dataProvider('array'), dataProvider('function'), dataProvider('function'), dataProvider('null'), dataProvider('number')].filter(isNil)
  ...
  test('isFunction: should work as type guard in filter', () => {
    const data = [dataProvider('error'), dataProvider('array'), dataProvider('function'), dataProvider('function'), dataProvider('object'), dataProvider('number')].filter(isFunction)
  ...
  test('isError: should work as type guard in filter', () => {
    const data = [dataProvider('error'), dataProvider('array'), dataProvider('boolean'), dataProvider('function'), dataProvider('object'), dataProvider('number')].filter(isError)
  ...
  test('isNumber: should work as type guard in filter', () => {
    const data = [dataProvider('promise'), dataProvider('array'), dataProvider('boolean'), dataProvider('function'), dataProvider('object'), dataProvider('number')].filter(isNumber)
  ...
  test('isObject: should work as type guard in filter', () => {
    const data = [dataProvider('promise'), dataProvider('array'), dataProvider('boolean'), dataProvider('function'), dataProvider('object')].filter(isObject)
    expect(data.every((c) => typeof c === 'object' && !Array.isArray(c))).toEqual(true)
    assertType<{ a: string }[]>(data)
  });
  ...
  test('isPromise: should work as type guard in filter', () => {
    const data = [dataProvider('promise'), dataProvider('array'), dataProvider('boolean'), dataProvider('function')].filter(isPromise)
